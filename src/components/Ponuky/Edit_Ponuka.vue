    ...
    <div class="Basic_Grey">
      ...
      <div class="formular">
        ...
        <div class="field">
          ...
          <textarea v-model="ponuka.informacie" @input="resize($event)"></textarea>
        </div>
        <div class="field">
          <p class="required">Ponuka platná od</p>
          <input type="date" name="od" v-model="ponuka.datum_od">
        </div>
        <div class="field">
          <p class="required">Ponuka platná do</p>
          <input type="date" name="do" v-model="ponuka.datum_do">
        </div>
        <div class="field">
        ...
        <div class="field">
          ...
          <select style="float: left" v-model="ponuka.program_id" @change="OborChange()">
            <option disabled selected value> -- Vyberte z možností --</option>
        ...
        <div class="field" v-if="ponuka.obor!=''">
          ...
          <select style="float: left" v-model="ponuka.zameranie_id">
            <option disabled selected value> -- Vyberte z možností --</option>
        ...
        <div class="field" style="padding-top: 40px">
          ...
          <button type="submit" @click="Update_ponuka">Upraviť Ponuku</button>
        </div>
    </div>
  </div>
</template>
  ...
  methods: {
    Update_ponuka() {
      if(this.ponuka.nazov=='' || this.ponuka.info=='' || this.ponuka.od=='' || this.ponuka.do=='' || this.ponuka.krajina_id=='' || this.ponuka.kraj_id=='' ||
        ...
        ApiRequests.Update_Ponuka(this.ponuka)
      }
    },
    resize(e) {
    ...
    OborChange(){
      ...
      for (let i = 0; i < this.zamerania.length; i++){
        if(this.zamerania[i].studentske_programy_id == this.ponuka.program_id){
